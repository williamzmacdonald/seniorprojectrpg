...
<div class="pages background">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="brand-heading font-black uppercase">Our Team:</h2>
            </div>
            <div class="col-lg-4 col-sm-6 text-center mb-4" style="margin-left: 100px; margin-top: 50px; margin-right: 100px;">
                ...
                <p class="font-black">Created the functionality of Evolved.</p>
            </div>
            <div class="col-lg-4 col-sm-6 text-center mb-4" style="margin-top: 50px;">
                ...
                <p class="font-black">Designed the layout of Evolved.</p>
            </div>
         </div>
    </div>
</div>
